...
public class MLUnitTypes {
    ...
    //二级
    ExpelDarkness, ChasingLight, Dawn, FlowingSun, SplendidBrilliant, Radiance,
    //核心机
    Popular, SpinningSpear, Nightingale,
    //星舰
    //小型
    ...
    public static void load() {
        ...
        TorrentialRain = new UnitType("TorrentialRain") {{
            ...
            range = 480;
            weapons.add(
            new Weapon("magic-TorrentialRain0") {{
                reload = 120f;
                recoil = 0f;
                x = 0;
                y = 0;
        ...
        MilkyWay = new UnitType("MilkyWay"){{
                ...
                abilities.add(new TargetTeleportAbility(300f, MLFx.jumpTrail.at(x, y, unit.rotation, unit.team.color, unit.type)));
            weapons.add(
