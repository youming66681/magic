...
public class MLBlocks {
    ...
    public static void load() {
        ...
        NanoCarbonAlloyCombiner = new GenericCrafter("NanoCarbonAlloyCombiner") {{
            ...
            consumePower(20f);
            consumeItems(ItemStack.with(MLItems.phantomLuminousAlloy, 1, MLItems.nanoEnergyThread, 1, MLItems.crystallineCarbon, 1));
        }};
        //factor
        //炮
        //电戈
        ...
        //耀世
        BrilliantWorld = new PowerTurret("BrilliantWorld"){{
            requirements(Category.turret, ItemStack.with(new Object[]{MLItems.phantomLuminousAlloy, 195, MLItems.fluorescentFeatherStone, 240, MLItems.wingedMetal, 320, Items.surgeAlloy, 270, MLItems.phantomTitaniumSteel, 465, MLItems.nanoEnergyThread, 120, MLItems.matrixChip, 60,}));
        ...
        //荧羽反应堆
        LumifeatherReactor = new PhantomReactor("LumifeatherReactor"){{
            ...
            consumeLiquids(LiquidStack.with(MLLiquids.PhantomSteelSolution, 0.25f,Liquids.water, 1));
        ...
        starHarborShipbuildingCenter = new FlexAssembler("starHarborShipbuildingCenter"){{
            ...
            addPlan("T2", MLUnitTypes.Tianshu, 4500f, 17, 1,
                    new PayloadStack(MLBlocks.largePhantomSteelWall, 10),
                    new PayloadStack(MLBlocks.largePhantomTitaniumSteelWall, 10),
                    new PayloadStack(MLBlocks.LargeWingWall, 10),
            ...
            addPlan("T2", MLUnitTypes.MoonRise, 18000f, 23, 1,
                    new PayloadStack(MLBlocks.largePhantomSteelWall, 18),
                    new PayloadStack(MLBlocks.largePhantomTitaniumSteelWall, 18),
                    new PayloadStack(MLBlocks.LargeWingWall, 18),
                    new PayloadStack(MLBlocks.LargePhantomGlowWall, 18),
        ...
        PretendingCore = new FlexAssembler("PretendingCore"){{
            ...
            addPlan("T2", MLUnitTypes.HeavyRain, 4800f, 13, 1,
                    new PayloadStack(MLBlocks.largePhantomSteelWall, 6),
            ...
            addPlan("T3", MLUnitTypes.VastOcean, 14400f, 17, 2,
                    new PayloadStack(MLBlocks.largePhantomSteelWall, 6),
                    new PayloadStack(MLBlocks.largePhantomTitaniumSteelWall, 6),
                    new PayloadStack(MLBlocks.LargeWingWall, 6),
                    new PayloadStack(MLUnitTypes.StillWater, 3),
                    new PayloadStack(MLUnitTypes.ripple, 3),
                    new PayloadStack(MLUnitTypes.Turbulence, 3));
            ...
            addPlan("T2", MLUnitTypes.BlazingSplendor, 7200f, 15, 1,
                    new PayloadStack(MLBlocks.largePhantomTitaniumSteelWall, 6),
                    new PayloadStack(MLBlocks.LargeWingWall, 6),
                    new PayloadStack(MLUnitTypes.BlazingFire, 3),
                    new PayloadStack(MLUnitTypes.glow, 3));
            addPlan("T3", MLUnitTypes.BrightStar, 21600f, 17, 2,
                    new PayloadStack(MLBlocks.largePhantomTitaniumSteelWall, 6),
                    new PayloadStack(MLBlocks.LargeWingWall, 6),
                    new PayloadStack(MLBlocks.LargePhantomGlowWall, 6),
                    new PayloadStack(MLUnitTypes.BlazingFire, 3),
                    new PayloadStack(MLUnitTypes.glow, 3),
                    new PayloadStack(MLUnitTypes.blazing, 3));
        ...
        //通用装配升级厂
        GeneralAssemblyUpgrade = new FlexAssembler.FlexAssemblerModule("GeneralAssemblyUpgrade"){{
        ...
        AdvancedGeneralAssemblyUpgradeFactory = new FlexAssembler.FlexAssemblerModule("AdvancedGeneralAssemblyUpgradeFactory"){{
